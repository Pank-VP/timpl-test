...
var BaseDirective = {
  ...
  _getPTDatasets: function _getPTDatasets() {
    ...
    return _objectSpread(_objectSpread({}, key === "root" && _defineProperty2({}, "".concat(datasetPrefix, "name"), toFlatCase(instance.$name))), {}, _defineProperty2({}, "".concat(datasetPrefix, "section"), toFlatCase(key)));
  },
  ...
  methods: {
    ...
    autoFocus: function autoFocus(options) {
      this.autoElementFocus(this.$el, {
        value: _objectSpread2(_objectSpread2({}, options), {}, {
          autoFocus: true
        })
      });
    },
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      var ink = createElement("span", _defineProperty4(_defineProperty4({
        role: "presentation",
        "aria-hidden": true,
        "data-p-ink": true,
...
function _toArray(r) {
  return _arrayWithHoles2(r) || _iterableToArray3(r) || _unsupportedIterableToArray4(r) || _nonIterableRest2();
}
...
var script2 = {
  ...
  methods: {
    ...
    _loadGlobalStyles: function _loadGlobalStyles() {
      ...
      isNotEmpty(globalCSS) && BaseStyle.load(globalCSS, _objectSpread3({
        name: "global"
      }, this.$styleOptions));
    },
    _loadThemeStyles: function _loadThemeStyles2() {
      ...
      if (!config_default.isStyleNameLoaded((_this$$style4 = this.$style) === null || _this$$style4 === void 0 ? void 0 : _this$$style4.name) && (_this$$style5 = this.$style) !== null && _this$$style5 !== void 0 && _this$$style5.name) {
        ...
        (_this$$style7 = this.$style) === null || _this$$style7 === void 0 || _this$$style7.load(css, _objectSpread3({
          name: "".concat(this.$style.name, "-variables")
        }, this.$styleOptions));
        (_this$$style8 = this.$style) === null || _this$$style8 === void 0 || _this$$style8.loadTheme(_objectSpread3({
    ...
    _loadScopedThemeStyles: function _loadScopedThemeStyles2(preset) {
      ...
      var scopedStyle = (_this$$style11 = this.$style) === null || _this$$style11 === void 0 ? void 0 : _this$$style11.load(css, _objectSpread3({
    ...
    _getPTDatasets: function _getPTDatasets2() {
      ...
      return key !== "transition" && _objectSpread3(_objectSpread3({}, key === "root" && _objectSpread3(_objectSpread3(_defineProperty5({}, "".concat(datasetPrefix, "name"), toFlatCase(isExtended ? (_this$pt5 = this.pt) === null || _this$pt5 === void 0 ? void 0 : _this$pt5["data-pc-section"] : this.$.type.name)), isExtended && _defineProperty5({}, "".concat(datasetPrefix, "extend"), toFlatCase(this.$.type.name))), isClient() && _defineProperty5({}, "".concat(this.$attrSelector), ""))), {}, _defineProperty5({}, "".concat(datasetPrefix, "section"), toFlatCase(key)));
    },
  ...
  computed: {
    ...
    defaultPT: function defaultPT() {
      ...
      return this._getPT((_this$$primevueConfig5 = this.$primevueConfig) === null || _this$$primevueConfig5 === void 0 ? void 0 : _this$$primevueConfig5.pt, void 0, function(value) {
        return _this5._getOptionValue(value, _this5.$name, _objectSpread3({}, _this5.$params)) || resolve(value, _objectSpread3({}, _this5.$params));
      });
    },
    ...
    $inProps: function $inProps() {
      ...
      return Object.fromEntries(Object.entries(this.$props).filter(function(_ref11) {
        var _ref12 = _slicedToArray2(_ref11, 1), k = _ref12[0];
    ...
    $_attrsPT: function $_attrsPT() {
      return Object.entries(this.$attrs || {}).filter(function(_ref13) {
        var _ref14 = _slicedToArray2(_ref13, 1), key = _ref14[0];
        return key === null || key === void 0 ? void 0 : key.startsWith("pt:");
      }).reduce(function(result, _ref15) {
        var _ref16 = _slicedToArray2(_ref15, 2), key = _ref16[0], value = _ref16[1];
    ...
    $_attrsWithoutPT: function $_attrsWithoutPT() {
      return Object.entries(this.$attrs || {}).filter(function(_ref17) {
        var _ref18 = _slicedToArray2(_ref17, 1), key = _ref18[0];
        return !(key !== null && key !== void 0 && key.startsWith("pt:"));
      }).reduce(function(acc, _ref19) {
        var _ref20 = _slicedToArray2(_ref19, 2), key = _ref20[0], value = _ref20[1];
        acc[key] = value;
        return acc;
      }, {});
    }
...
//# sourceMappingURL=chunk-EXHHXTZP.js.map
