...
var _default = function() {
  ...
  return _createClass(_default4, [{
    ...
    value: function get(parentInstance, slots) {
      ...
      var computed2 = children ? this._recursive(_toConsumableArray(this.helpers), children) : null;
  ...
  methods: {
    ...
    autoFocus: function autoFocus(options) {
      this.autoElementFocus(this.$el, {
        value: _objectSpread4(_objectSpread4({}, options), {}, {
          autoFocus: true
        })
      });
    },
...
var script10 = {
  ...
  components: {
    Button: script8,
    Portal: script9,
    WindowMinimizeIcon: script5,
    WindowMaximizeIcon: script4,
    TimesIcon: script3
  }
};
function _typeof8(o) {
    ...
    "default": withCtx(function() {
      return [$data.containerVisible ? (openBlock(), createElementBlock("div", mergeProps({
        ...
        "default": withCtx(function() {
          ...
          }, _objectSpread5(_objectSpread5({}, _ctx.contentProps), _ctx.ptm("content"))), [renderSlot(_ctx.$slots, "default")], 16), _ctx.footer || _ctx.$slots.footer ? (openBlock(), createElementBlock("div", mergeProps({
            key: 1,
